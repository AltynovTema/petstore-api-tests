...
def created_pet(): # Код внутри этой функции created_pet будет выполнен, когда pytest вызовет фикстуру @pytest.fixture, и передаст результат тесту yield pet_id.
    pet_data = {
